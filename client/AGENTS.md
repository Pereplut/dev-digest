...
- UI primitives come from `@devdigest/ui` (`src/vendor/ui`); contracts from `@devdigest/shared` (`src/vendor/shared`, a vendored copy — see [shared AGENTS.md](../server/src/vendor/shared/AGENTS.md)).
- Real browser journeys are covered in [`../e2e`](../e2e/AGENTS.md), not here.
