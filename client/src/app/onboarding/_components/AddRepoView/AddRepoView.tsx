...
import { Button, Icon, IconBtn, Kbd, TextInput, FormField } from "@/components/ui-client";
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)", marginTop: 8, marginBottom: 28, lineHeight: 1.5 }}>
          {/* t.rich keeps the link INSIDE the sentence: splitting the copy into
              "…set them once in" + link + "." would make it untranslatable for
              any language that orders the clause differently. */}
          {t.rich("addRepo.body", {
            link: (chunks) => (
