...
| [react-code-organization](react-code-organization/SKILL.md) | Frontend | Where code goes: folder structure, component splitting, logic layering, constants/utils/types placement |
